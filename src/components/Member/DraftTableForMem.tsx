...
// ================================================
// DraftTableForMem.tsx
// Member: ตาราง "ฉบับร่าง" (UI เท่านั้น / ยังไม่ผูก DB)
// เงื่อนไขสำคัญ:
...
export default function DraftTableForMem({ rowsFromApi }: Props) {
  ...
  const headerLabels = [ "ชื่อแพ็กเกจ", "ชื่อชุมชน", "คนดูแล", "สถานะแพ็กเกจ", "จัดการ"];
