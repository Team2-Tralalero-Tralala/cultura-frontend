...
// ================================================
// PackageApprovalTable.tsx
// Super Admin: ตาราง "จัดการอนุมัตขอคำ"แพ็กเกจ (UI เท่านั้น / ยังไม่ผูก DB)
// เงื่อนไขสำคัญ:
...
export default function PackageApprovalTable({ rowsFromApi }: Props) {
