/*
 * คำอธิบาย : Type สำหรับกำหนดโครงสร้างข้อมูลแถวของตารางการจอง (สำหรับ Admin ชุมชน)
