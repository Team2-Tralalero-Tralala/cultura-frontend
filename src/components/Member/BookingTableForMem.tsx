...
// ================================================
// BookingTableForMem.tsx
// Member: ตาราง "จัดการการจอง" (UI เท่านั้น / ยังไม่ผูก DB)
// เงื่อนไขสำคัญ:
...
export type BookingRow = {
  ...
  price: string;          // ราคา
  status: string;         // สถานะ (รอตรวจสอบ / รอคืนเงิน / อนุมัติ ฯลฯ)
  slip: string;           // หลักฐานการชำระเงิน
};
// 2) พร็อพรองรับการส่งข้อมูลจากภายนอกได้ด้วย (ถ้าอยากควบคุมจากหน้า parent)
type Props = {
  rowsFromApi?: BookingRow[];
};

export default function BookingTableForMem({ rowsFromApi }: Props) {
