  ...
  return (
    <div>
      ...
      <button
        ...
        className="flex items-center justify-between px-6 py-2 bg-white border border-black rounded-lg hover:bg-gray-50"
      >
      ...
      {/* กล่อง dropdown */}
      {open && (
        <div className="absolute z-10 mt-2 bg-white border border-black rounded-lg p-4 space-y-4">
          {/* สถานะแพ็กเกจ */}
          <div>
