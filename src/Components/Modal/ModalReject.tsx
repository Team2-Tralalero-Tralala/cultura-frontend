// src/Components/Modal/ModalReject.tsx
/**
 * Modal ปฏิเสธคำขอ (SweetAlert2)
 * - แสดง textarea ให้กรอกเหตุผล
 * - จำกัดความยาวตาม DTO (ดีฟอลต์ 100)
 * - มีปุ่ม ยืนยัน/ยกเลิก
 * หมายเหตุ: ปรับเฉพาะรูปแบบโค้ดตาม code style โดยไม่เปลี่ยนพฤติกรรมการทำงาน
 */
...
/** โครงสร้าง props สำหรับ RejectModal */
