 ...
 *  ใช้โดยผู้ดูแลชุมชน (Admin) เพื่อดูข้อมูลการจอง,
 *  ข้อมูลผู้จอง, แพ็กเกจ, หลักฐานการโอนเงิน
 *  และเหตุผลที่เกี่ยวข้องกับการปฏิเสธหรือการคืนเงิน
 *
 * Input:
 *  - bookingId: string (รับจาก URL parameter)

 * Output:
 *  - แสดงรายละเอียดการจองตามสถานะ
 */
...
/**
 * Function: BookingDetailStatusAdmin
 *
 * คำอธิบาย:
 *  Page Component สำหรับแสดงรายละเอียดการจองแพ็กเกจทัวร์ในมุมมองของ Admin
 *  ทำหน้าที่ดึงข้อมูลการจองจาก Backend ตาม bookingId
 *  และแสดงข้อมูลผู้จอง, แพ็กเกจ, หลักฐานการโอนเงิน
 *  รวมถึงเหตุผลที่เกี่ยวข้องกับการปฏิเสธหรือการคืนเงินตามสถานะการจอง
 *
 * Input:
 *  - bookingId: string (รับจาก URL parameter ผ่าน useParams)
 *
 * Output:
 *  - แสดงหน้ารายละเอียดการจองของ Admin
 *
 * Side Effects:
 *  - เรียก API เพื่อดึงข้อมูลรายละเอียดการจอง
 *  - อัปเดต state: booking, loading, error
 */
export default function BookingDetailStatusAdmin() {
   ...
   *
   * คำอธิบาย:
   *  ใช้สำหรับดึงข้อมูลรายละเอียดการจองจากระบบ Backend
   *
   * Input:
   *  - bookingId จาก URL
   *
   * Output:
   *  - อัปเดต state booking หรือ error
   */
 ...
 *
 * คำอธิบาย:
 *  ใช้แปลงวันที่จาก string ให้เป็นรูปแบบวันที่ภาษาไทย
 *
 * Input:
 *  - inputDate: string | null
 *
 * Output:
 *  - string วันที่ในรูปแบบอ่านง่าย
 */
