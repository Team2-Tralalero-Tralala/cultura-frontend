 ...
 *  - แสดงข้อมูลนักท่องเที่ยว แพ็กเกจ ทริป และหลักฐานการโอนเงิน
 *
 * เส้นทางที่ดึงข้อมูล:
 ...
 * ฟีเจอร์:
 *   - แสดงข้อมูลการจอง
 *   - Modal ยืนยันอนุมัติการจอง
 *   - Modal กรอกเหตุผลสำหรับปฏิเสธการจอง
 */
...
export default function BookingDetailAdmin() {
   ...
   *
   * Input:
   *  - reason: string → เหตุผลที่ปฏิเสธจาก modal
   *
   * Output:
