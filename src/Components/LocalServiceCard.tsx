 ...
 * Input :
 *   - id (number) : รหัสของบริการ
 *   - name (string) : ชื่อของบริการ
 *   - imageUrl (string, optional) : URL ของรูปภาพปก
 *   - to (string) : เส้นทาง URL ที่จะลิงก์ไป
 *   - onClick (function, optional) : ฟังก์ชันที่จะทำงานเมื่อคลิก
 * Output :
 *   - การ์ดแสดงผลรูปภาพและชื่อบริการ ที่สามารถคลิกได้
 */
