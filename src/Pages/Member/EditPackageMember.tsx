...
export default function EditPackage() {
  ...
  // TODO: preload รายละเอียดเดิมเมื่อมี GET /super/packages/:id
  // React.useEffect(() => { ... }, [id])
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const payload = {
        ...
        statusApprove: form.statusApprove,
      ...
      // ✅ เรียก backend รูปแบบเดียวกับ create (axios + VITE_API_URL)
      // หมายเหตุ: ตรวจเส้นทางของคุณให้ตรง (super/package vs super/packages)
      await axios.put(`${apiUrl}/super/packages/${id}`, payload, {
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-3">
        <button onClick={() => navigate(-1)} className="rounded-form px-3 py-2 border text-sm">
          ← ย้อนกลับ
        </button>
        ...
        <section className="grid md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => set("statusPackage", e.target.value as FormState["statusPackage"])}
            >
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => set("statusApprove", e.target.value as FormState["statusApprove"])}
            >
